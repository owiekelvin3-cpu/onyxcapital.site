...
import { SuspendedAccountNotice } from "@/components/marketing/SuspendedAccountNotice";
  ...
  return (
    <div className="fin-marketing flex min-h-dvh w-full min-w-0 flex-col overflow-x-clip lg:flex-row">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-x-clip">
        ...
        <main className="flex-1 px-4 py-5 safe-area-x sm:px-6 sm:py-6 lg:px-8 lg:py-8">
